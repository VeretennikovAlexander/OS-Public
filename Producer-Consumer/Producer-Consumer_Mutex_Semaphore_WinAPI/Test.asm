; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	g:\Data\Projects\Commands\OSNew\NotesTex\Examples\Synchronization\Semaphore\Test.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?N@@3IA						; N
PUBLIC	?Processed@@3IA					; Processed
PUBLIC	?MaxItems@@3IA					; MaxItems
_BSS	SEGMENT
?Processed@@3IA DD 01H DUP (?)				; Processed
...
PUBLIC	??0CSemaphore@@QAE@HH@Z				; CSemaphore::CSemaphore
PUBLIC	?Down@CSemaphore@@QAEXXZ			; CSemaphore::Down
PUBLIC	?Up@CSemaphore@@QAEXXZ				; CSemaphore::Up
PUBLIC	??1CSemaphore@@QAE@XZ				; CSemaphore::~CSemaphore
...
PUBLIC	__TI1?AVCCreateSemaphoreException@@
PUBLIC	__CTA1?AVCCreateSemaphoreException@@
PUBLIC	??_R0?AVCCreateSemaphoreException@@@8		; CCreateSemaphoreException `RTTI Type Descriptor'
PUBLIC	__CT??_R0?AVCCreateSemaphoreException@@@81
PUBLIC	?Mutex@@3VCSemaphore@@A				; Mutex
PUBLIC	?Empty@@3VCSemaphore@@A				; Empty
PUBLIC	?Full@@3VCSemaphore@@A				; Full
...
_BSS	ENDS
_BSS	SEGMENT
?Mutex@@3VCSemaphore@@A DD 01H DUP (?)			; Mutex
?Empty@@3VCSemaphore@@A DD 01H DUP (?)			; Empty
?Full@@3VCSemaphore@@A DD 01H DUP (?)			; Full
	ALIGN	8
...
_BSS	ENDS
CRT$XCU	SEGMENT
?Mutex$initializer$@@3P6AXXZA DD FLAT:??__EMutex@@YAXXZ	; Mutex$initializer$
CRT$XCU	ENDS
...
??_C@_0DL@HDGCFIPI@Processed?5?$CFd?0?5max?5?$CFd?0?5current?5?$CFd@ DB 'P'
	...
	DB	0aH, 00H					; `string'
CONST	ENDS
;	COMDAT __CT??_R0?AVCCreateSemaphoreException@@@81
xdata$x	SEGMENT
__CT??_R0?AVCCreateSemaphoreException@@@81 DD 00H
	DD	FLAT:??_R0?AVCCreateSemaphoreException@@@8
	DD	00H
	DD	0ffffffffH
	ORG $+4
	DD	01H
	DD	00H
xdata$x	ENDS
;	COMDAT ??_R0?AVCCreateSemaphoreException@@@8
data$r	SEGMENT
??_R0?AVCCreateSemaphoreException@@@8 DD FLAT:??_7type_info@@6B@ ; CCreateSemaphoreException `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVCCreateSemaphoreException@@', 00H
data$r	ENDS
;	COMDAT __CTA1?AVCCreateSemaphoreException@@
xdata$x	SEGMENT
__CTA1?AVCCreateSemaphoreException@@ DD 01H
	DD	FLAT:__CT??_R0?AVCCreateSemaphoreException@@@81
xdata$x	ENDS
;	COMDAT __TI1?AVCCreateSemaphoreException@@
xdata$x	SEGMENT
__TI1?AVCCreateSemaphoreException@@ DD 00H
	DD	00H
	DD	00H
	DD	FLAT:__CTA1?AVCCreateSemaphoreException@@
xdata$x	ENDS
CRT$XCU	SEGMENT
?Empty$initializer$@@3P6AXXZA DD FLAT:??__EEmpty@@YAXXZ	; Empty$initializer$
CRT$XCU	ENDS
CRT$XCU	SEGMENT
?Full$initializer$@@3P6AXXZA DD FLAT:??__EFull@@YAXXZ	; Full$initializer$
CRT$XCU	ENDS
CRT$XCU	SEGMENT
...
_args$ = 8						; size = 4
_main	PROC						; COMDAT
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 225
...
; Line 176
	...
	push	ebx
	mov	ebx, DWORD PTR __imp__ReleaseSemaphore@12
	push	esi
	mov	esi, DWORD PTR __imp__WaitForSingleObject@8
	push	edi
; Line 179
$LL8@Execute:
	push	0
	push	DWORD PTR ?Full@@3VCSemaphore@@A	; Full
	call	esi
	test	eax, eax
...
$LL13@Execute:
	push	0
	push	DWORD PTR ?Mutex@@3VCSemaphore@@A	; Mutex
	call	esi
	test	eax, eax
...
; Line 186
	mov	ecx, DWORD PTR ?Processed@@3IA		; Processed
	mov	eax, 1334532239				; 4f8b588fH
	inc	ecx
	add	esp, 4
	mul	ecx
	mov	eax, ecx
	mov	DWORD PTR ?Processed@@3IA, ecx		; Processed
	sub	eax, edx
	shr	eax, 1
	add	eax, edx
	...
	xor	eax, eax
	xorps	xmm0, xmm0
	mov	WORD PTR _S$2[esp+40], ax
	mov	DWORD PTR _S$2[esp+50], eax
	mov	WORD PTR _S$2[esp+54], ax
	mov	DWORD PTR _F$1[esp+40], eax
	mov	DWORD PTR _F$1[esp+44], eax
	lea	eax, DWORD PTR _S$2[esp+40]
	push	eax
	movq	QWORD PTR _S$2[esp+46], xmm0
	call	DWORD PTR __imp__GetSystemTime@4
	lea	eax, DWORD PTR _F$1[esp+40]
	push	eax
	lea	eax, DWORD PTR _S$2[esp+44]
	push	eax
	call	DWORD PTR __imp__SystemTimeToFileTime@8
	push	0
	push	10000					; 00002710H
	push	DWORD PTR _F$1[esp+52]
	push	DWORD PTR _F$1[esp+52]
	call	__alldiv
	mov	edi, DWORD PTR ?Processed@@3IA		; Processed
	mov	ebx, eax
	sub	ebx, DWORD PTR ?Start@@3_JA
	sbb	edx, DWORD PTR ?Start@@3_JA+4
	push	edx
	imul	ecx, edi, 1000
	push	ebx
	push	0
...
; Line 189
	push	0
	push	1
	push	DWORD PTR ?Empty@@3VCSemaphore@@A	; Empty
	call	ebx
	jmp	$LL8@Execute
...
; Line 168
	mov	esi, DWORD PTR ?Processed@@3IA		; Processed
	mov	edi, eax
	sub	edi, DWORD PTR ?Start@@3_JA
	sbb	edx, DWORD PTR ?Start@@3_JA+4
	push	edx
	imul	ecx, esi, 1000
	push	edi
...
; Line 111
	...
	push	ebx
	push	ebp
	mov	ebp, DWORD PTR __imp__ReleaseSemaphore@12
	push	esi
	mov	esi, DWORD PTR __imp__WaitForSingleObject@8
	push	edi
; Line 114
...
text$di	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??__FFull@@YAXXZ
text$yd	SEGMENT
??__FFull@@YAXXZ PROC					; `dynamic atexit destructor for 'Full'', COMDAT
	push	DWORD PTR ?Full@@3VCSemaphore@@A	; Full
	call	DWORD PTR __imp__CloseHandle@4
	ret	0
??__FFull@@YAXXZ ENDP					; `dynamic atexit destructor for 'Full''
text$yd	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??__EFull@@YAXXZ
text$di	SEGMENT
$T1 = -1						; size = 1
??__EFull@@YAXXZ PROC					; `dynamic initializer for 'Full'', COMDAT
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 94
	push	ecx
	push	0
	push	DWORD PTR ?N@@3IA			; N
	push	0
	push	0
	call	DWORD PTR __imp__CreateSemaphoreA@16
	mov	DWORD PTR ?Full@@3VCSemaphore@@A, eax	; Full
	test	eax, eax
	je	SHORT $LN8@dynamic
	push	OFFSET ??__FFull@@YAXXZ			; `dynamic atexit destructor for 'Full''
	call	_atexit
	add	esp, 4
	pop	ecx
	ret	0
$LN8@dynamic:
	push	OFFSET __TI1?AVCCreateSemaphoreException@@
...
$LN7@dynamic:
	int	3
??__EFull@@YAXXZ ENDP					; `dynamic initializer for 'Full''
text$di	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??__FEmpty@@YAXXZ
text$yd	SEGMENT
??__FEmpty@@YAXXZ PROC					; `dynamic atexit destructor for 'Empty'', COMDAT
	push	DWORD PTR ?Empty@@3VCSemaphore@@A	; Empty
	call	DWORD PTR __imp__CloseHandle@4
	ret	0
??__FEmpty@@YAXXZ ENDP					; `dynamic atexit destructor for 'Empty''
text$yd	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??__EEmpty@@YAXXZ
text$di	SEGMENT
$T1 = -1						; size = 1
??__EEmpty@@YAXXZ PROC					; `dynamic initializer for 'Empty'', COMDAT
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 93
	push	ecx
	mov	eax, DWORD PTR ?N@@3IA			; N
	push	0
	push	eax
	push	eax
	push	0
	call	DWORD PTR __imp__CreateSemaphoreA@16
	mov	DWORD PTR ?Empty@@3VCSemaphore@@A, eax	; Empty
	test	eax, eax
	je	SHORT $LN8@dynamic
	push	OFFSET ??__FEmpty@@YAXXZ		; `dynamic atexit destructor for 'Empty''
	call	_atexit
	add	esp, 4
	pop	ecx
	ret	0
...
$LN7@dynamic:
	int	3
??__EEmpty@@YAXXZ ENDP					; `dynamic initializer for 'Empty''
text$di	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??__FMutex@@YAXXZ
text$yd	SEGMENT
??__FMutex@@YAXXZ PROC					; `dynamic atexit destructor for 'Mutex'', COMDAT
	push	DWORD PTR ?Mutex@@3VCSemaphore@@A	; Mutex
	call	DWORD PTR __imp__CloseHandle@4
	ret	0
??__FMutex@@YAXXZ ENDP					; `dynamic atexit destructor for 'Mutex''
text$yd	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??__EMutex@@YAXXZ
text$di	SEGMENT
$T1 = -1						; size = 1
??__EMutex@@YAXXZ PROC					; `dynamic initializer for 'Mutex'', COMDAT
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 92
	push	ecx
	push	0
	...
	push	0
	call	DWORD PTR __imp__CreateSemaphoreA@16
	mov	DWORD PTR ?Mutex@@3VCSemaphore@@A, eax	; Mutex
	test	eax, eax
	je	SHORT $LN8@dynamic
	push	OFFSET ??__FMutex@@YAXXZ		; `dynamic atexit destructor for 'Mutex''
	call	_atexit
	add	esp, 4
	pop	ecx
	ret	0
...
$LN7@dynamic:
	int	3
??__EMutex@@YAXXZ ENDP					; `dynamic initializer for 'Mutex''
text$di	ENDS
; Function compile flags: /Ogtpy
...
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??1CSemaphore@@QAE@XZ
_TEXT	SEGMENT
??1CSemaphore@@QAE@XZ PROC				; CSemaphore::~CSemaphore, COMDAT
; _this$ = ecx
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 74
	push	DWORD PTR [ecx]
...
; Line 75
	ret	0
??1CSemaphore@@QAE@XZ ENDP				; CSemaphore::~CSemaphore
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?Up@CSemaphore@@QAEXXZ
_TEXT	SEGMENT
?Up@CSemaphore@@QAEXXZ PROC				; CSemaphore::Up, COMDAT
; _this$ = ecx
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 69
	push	0
...
; Line 70
	ret	0
?Up@CSemaphore@@QAEXXZ ENDP				; CSemaphore::Up
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ?Down@CSemaphore@@QAEXXZ
_TEXT	SEGMENT
?Down@CSemaphore@@QAEXXZ PROC				; CSemaphore::Down, COMDAT
; _this$ = ecx
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 56
	push	esi
...
; Line 65
	...
	pop	esi
	ret	0
?Down@CSemaphore@@QAEXXZ ENDP				; CSemaphore::Down
_TEXT	ENDS
; Function compile flags: /Ogtpy
;	COMDAT ??0CSemaphore@@QAE@HH@Z
_TEXT	SEGMENT
_Inititial$ = 8						; size = 4
$T1 = 12						; size = 1
_Max$ = 12						; size = 4
??0CSemaphore@@QAE@HH@Z PROC				; CSemaphore::CSemaphore, COMDAT
; _this$ = ecx
; File g:\data\projects\commands\osnew\notestex\examples\synchronization\semaphore\test.cpp
; Line 46
	push	esi
; Line 48
	push	0
	push	DWORD PTR _Max$[esp+4]
	mov	esi, ecx
	push	DWORD PTR _Inititial$[esp+8]
	push	0
	call	DWORD PTR __imp__CreateSemaphoreA@16
	mov	DWORD PTR [esi], eax
; Line 49
	test	eax, eax
	je	SHORT $LN5@CSemaphore
; Line 53
	mov	eax, esi
	pop	esi
	ret	8
...
$LN4@CSemaphore:
	int	3
??0CSemaphore@@QAE@HH@Z ENDP				; CSemaphore::CSemaphore
_TEXT	ENDS
; Function compile flags: /Ogtpy
